...
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool) *protogen.GeneratedFile {
	...
	g.P("// Code generated by protoc-gen-go-gin-http. DO NOT EDIT.")
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-gen-go-gin-http %s", release))
	...
	for v, s := range vars {
		...
		for _, field := range strings.Split(v, ".") {
			...
			if fd == nil {
				fmt.Fprintf(
					os.Stderr,
					"\u001B[31mERROR\u001B[m: The corresponding field '%s' declaration in message could not be found in '%s'\n",
					v,
					path,
				)
				os.Exit(2)
